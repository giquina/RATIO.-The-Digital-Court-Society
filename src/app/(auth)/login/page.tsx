...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-4 md:px-6 lg:px-8">
      ...
      >
        {/* Google — placeholder for future OAuth */}
        <button
          type="button"
        ...
        <div className="bg-navy-card border border-court-border rounded-xl p-3 mt-1">
          <p className="text-court-xs text-court-text-ter text-center mb-1.5">Demo credentials</p>
          <p className="text-court-xs text-court-text-sec text-center font-mono">demo@ratio.law / ratio2026</p>
        </div>
