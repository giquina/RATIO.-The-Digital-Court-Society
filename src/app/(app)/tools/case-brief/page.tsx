...
Generated by Ratio. AI-generated analysis — always verify against primary sources.`;
  ...
  return (
    <div className="pb-6 md:max-w-content-narrow mx-auto">
      ...
      {/* Disclaimer */}
      <section className="px-4 md:px-6 lg:px-8 mb-4">
        <div className="flex items-start gap-2 px-3 py-2 rounded-xl bg-gold/5 border border-gold/10">
          <AlertTriangle size={14} className="text-gold shrink-0 mt-0.5" />
          <p className="text-court-xs text-court-text-sec">
            AI-powered analysis sourced from UK legal databases. We recommend
            verifying citations against primary sources — a core skill of good
            legal practice.
          </p>
        </div>
      </section>
