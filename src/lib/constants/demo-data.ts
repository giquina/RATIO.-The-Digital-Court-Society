...
export const DEMO_ACTIVITY_FEED = [
  {
    ...
    icon: "Scale",
    author: { name: "Priya Mehta", uni: "KCL", chamber: "Denning" },
  },
  {
    _id: "demo_act_2",
    type: "badge_earned",
    title: "Badge earned: Seasoned Counsel",
    description: "Completed 20 Moot Court sessions",
    timestamp: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString(),
    icon: "Award",
    author: { name: "James Okonkwo", uni: "UCL", chamber: "Arden" },
  },
  {
    _id: "demo_act_3",
    type: "session_created",
    title: "Created a group moot session",
    description: "Constitutional Law — Parliamentary Sovereignty",
    timestamp: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString(),
    icon: "Calendar",
    author: { name: "Sophie Chen", uni: "BBK", chamber: "Hale" },
  },
  {
    _id: "demo_act_4",
    type: "streak",
    title: "7-day practice streak!",
    description: "Practised every day this week",
    timestamp: new Date(Date.now() - 48 * 60 * 60 * 1000).toISOString(),
    icon: "Flame",
    author: { name: "Marcus Williams", uni: "SOAS", chamber: "Denning" },
  },
];
...
export const DEMO_NOTIFICATIONS = [
  ...
  },
  {
    ...
    body: "You completed your first Moot Court session. Keep going!",
    read: false,
