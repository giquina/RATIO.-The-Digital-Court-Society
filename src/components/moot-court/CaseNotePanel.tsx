...
export default function CaseNotePanel({
  ...
  const generateTextVersion = (note: CaseNote): string => {
    const lines = [
      ...
      "",
      "───────────────────────────────────────────────────────",
      "Generated by RATIO — The Digital Court Society.",
      "Sourced from UK legal databases. Verify citations against primary authorities.",
      "═══════════════════════════════════════════════════════",
    ];
    return lines.join("\n");
  };
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-4 py-4 no-scrollbar">
                ...
                <p className="text-court-xs text-court-text-ter text-center mt-4">
                  AI-powered analysis sourced from UK legal databases. Verify citations against primary sources.
                </p>
              </div>
            </motion.div>
          </>
