...
export default function InstallBanner() {
  ...
  return (
    <div className="fixed top-[56px] left-3 right-3 z-[60] animate-in slide-in-from-top-4 duration-300 md:top-auto md:bottom-6 md:right-auto md:left-[96px] lg:left-[264px] md:max-w-sm md:slide-in-from-bottom-4">
